...
class AddSection extends Component {
    ...
    render() { 
        return (
        <div className="bg-white lg:h-full flex flex-col  place-items-center justify-evenly">
            ...
            <button class="bg-[#4285F4] mt-[30px] mb-[10px] lg:mt-[-150px] lg:ml-[600px] md:ml-[10px] lg:w-[215px] lg:h-[44px] w-[270px] h-[44px] md:text-[16px] text-[13px] rounded-md  p-3 text-white"><Link to="/" > Ajouter l'annonce</Link></button>  
