   ...
   const handleClick =()=> {
    ...
    return(
        <div className="static">
            <div className="grid grid-cols-1 h-60 w-[330px] justify-items-center items-center bg-white rounded-lg cursor-pointer " onClick={handleClick}>
        <div className="h-44 w-80 bg-gray-400 rounded-lg">
        </div>
